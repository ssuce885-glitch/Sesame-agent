  ...
  "en-US": {
    ...
    runtime: {
      ...
      checkpoints: {
        ...
        subtitle: "Shadow Git snapshots captured before file-modifying tools run",
        empty: "No file checkpoints recorded yet.",
        loading: "Loading file checkpoints...",
        loadingDiff: "Loading diff...",
        noDiff: "No diff recorded for this checkpoint.",
        rollback: "Rollback",
        unknownTool: "tool",
        filesChanged: "{count} files changed",
        moreFiles: "+{count} more",
        confirmRollback: "Rollback workspace files to the checkpoint before {tool}?",
      },
    },
  },
  "zh-CN": {
    ...
    runtime: {
      ...
      checkpoints: {
        title: "文件检查点",
        subtitle: "文件修改工具运行前捕获的 shadow Git 快照",
        empty: "还没有记录文件检查点。",
        loading: "正在加载文件检查点...",
        loadingDiff: "正在加载 diff...",
        noDiff: "该检查点没有记录 diff。",
        rollback: "回滚",
        unknownTool: "工具",
        filesChanged: "{count} 个文件变更",
        moreFiles: "另有 {count} 个",
        confirmRollback: "将工作区文件回滚到 {tool} 之前的检查点？",
      },
    },
  },
};
