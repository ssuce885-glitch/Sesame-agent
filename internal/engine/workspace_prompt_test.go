...
func TestLoadWorkspacePromptBundleOrdersPromptAndRules(t *testing.T) {
	root := t.TempDir()
	writeWorkspaceFile(t, root, ".sesame/prompt.md", "workspace prompt")
	writeWorkspaceFile(t, root, ".sesame/rules/10-go.md", "go rule")
	writeWorkspaceFile(t, root, ".sesame/rules/00-core.md", "core rule")
	writeWorkspaceFile(t, root, ".sesame/rules/20-tests.md", "tests rule")
...
func TestLoadWorkspacePromptBundleReturnsNoticeOnBudgetOverflow(t *testing.T) {
	root := t.TempDir()
	writeWorkspaceFile(t, root, ".sesame/prompt.md", "12345")
	writeWorkspaceFile(t, root, ".sesame/rules/00-core.md", "rule")
...
func TestLoadWorkspacePromptBundleSkipsPathsFrontmatter(t *testing.T) {
	root := t.TempDir()
	writeWorkspaceFile(t, root, ".sesame/rules/00-core.md", "---\npaths:\n  - internal/**\n---\ncore rule")
...
func TestLoadWorkspacePromptBundleReturnsErrorWhenPromptPathIsUnreadable(t *testing.T) {
	root := t.TempDir()
	promptPath := filepath.Join(root, ".sesame", "prompt.md")
...
func TestLoadWorkspacePromptBundleSkipsUnreadableRuleFile(t *testing.T) {
	root := t.TempDir()
	writeWorkspaceFile(t, root, ".sesame/rules/00-good.md", "good rule")
	writeWorkspaceFile(t, root, ".sesame/rules/10-bad.md", "bad rule")
